...
exports.pseudos = exports.filters = exports.is = exports.selectOne = exports.selectAll = exports._compileToken = exports._compileUnsafe = exports.compile = void 0;
...
function getSelectorFunc(searchFunc) {
    return function select(query, elements, options) {
        ...
        if (typeof query !== "function") {
            query = compile_1.compileUnsafe(query, opts, elems);
        }
        /*
        ...
        if (query.shouldTestNextSiblings) {
            elems = appendNextSiblings((_a = opts.context) !== null && _a !== void 0 ? _a : elems, opts.adapter);
        }
        var filteredElements = Array.isArray(elems)
